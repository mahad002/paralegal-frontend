...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t bg-slate-800/50 font-medium text-slate-300", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle font-semibold text-gold-100 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
